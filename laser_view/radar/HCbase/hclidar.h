...
public:
    ...
    {
        return (getFactoryInfo() + "-" + getLidarModel() + "-" + getFirmwareVersion() + "-" + getHardwareVersion());
    }
	...
	//init sdk
    BOOL initialize(const char* chLidarModel, int iReadTimeoutMs, bool bDistQ2,bool bGetLoopData, bool bPollMode);
...
private:
    ...
    void threadParse(uint8_t *data, uint64_t size);
...
private:
    ...
    FullScanFilter scan_filter_;
    FilterPara filter_inf_;
